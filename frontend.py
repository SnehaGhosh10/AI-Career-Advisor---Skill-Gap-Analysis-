...
# Inject custom CSS for dual blue-white gradient background and clean card-like container
st.markdown("""
    <style>
    .stApp {
    ...
    if st.button("🚀 Analyze", use_container_width=True):
        if uploaded_resume and jd_text.strip():
            ...
            if "error" in result:
                ...
                st.markdown(f"<h2 style='color:#00796b'>{result['match_score']}%</h2>", unsafe_allow_html=True)
